...
import {CanvasTexture, RepeatWrapping, SRGBColorSpace, Texture, Vector2, VideoTexture} from 'three';
...
interface CustomVideoTexture {
    videoElement: HTMLVideoElement,
    modelViewerTexture: ModelViewerTexture
}
...
export const SceneGraphMixin = <T extends Constructor<ModelViewerElementBase>>(
    ...
    private[$buildTexture](texture: Texture, video?: boolean): ModelViewerTexture {
        ...
        createVideoTexture(uri: string, nostart?: boolean): CustomVideoTexture {
            ...
            return {
                videoElement: video,
                modelViewerTexture: this[$buildTexture](texture, true)
            };
        }
